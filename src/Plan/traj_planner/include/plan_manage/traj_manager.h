...
class TrajPlanner {
 public:
  ...
  ///////////////////////////////////////////////////////////////
  TrajPlanner(ros::NodeHandle nh, int ego_id, bool enable_urban)
      : nh_(nh), ego_id_(ego_id), enable_urban_(enable_urban) {}
  ~TrajPlanner() {
    /*hzc teb*/
 ...
 private:
  ...
  ErrorType ConverSurroundTrajFromPoints(std::vector<std::vector<common::State>> sur_trajs,
